...
- Screenshots: ImgBB (arrives with the trade form)

This is version 0.1.0: sign in, accounts, instruments with manual contract sizes, light and dark themes, offline-first sync, installable app shell. The trade form, calendar, analytics and recommendations arrive in the next builds.
